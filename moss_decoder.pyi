...
def decode_events_take_n(
    raw_bytes: bytes, take: int, skip: Optional[int], prepend_buffer: Optional[bytes]
) -> tuple[list[MossPacket], int]: ...
def decode_events_skip_n_take_all_with_remainder(
    raw_bytes: bytes, skip: int
